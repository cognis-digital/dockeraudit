#!/usr/bin/env sh
# Universal installer for dockeraudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dockeraudit.git"
echo "Installing dockeraudit ..."
...
echo "Done. Run: dockeraudit --help"
