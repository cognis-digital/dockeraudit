"""DOCKERAUDIT core — Audit Dockerfiles + image configs for security smells."""
...
RULES = [
    ("DOC-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("DOC-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("DOC-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
